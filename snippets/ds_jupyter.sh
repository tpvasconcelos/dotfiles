...
pipenv run jupyter labextension install @jupyterlab/toc @ryantam626/jupyterlab_code_formatter @jupyter-widgets/jupyterlab-manager@2.0 @oriolmirosa/jupyterlab_materialdarker jupyterlab-plotly@4.9.0 @jupyter-widgets/jupyterlab-manager plotlywidget@4.9.0
