...
_install_gh_extensions() {
  log_info "Installing some useful GitHib CLI (gh) extensions..."
...
if gh auth status &>/dev/null; then
  ...
  if ask-yesno "$msg"; then
    ...
    log_warning "Skipping... If you're interested, you will have to install the following GitHub CLI extensions yourself: github/gh-copilot, yusukebe/gh-markdown-preview, dlvhdr/gh-dash"
  fi
fi
