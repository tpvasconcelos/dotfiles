# Generated by Powerlevel10k configuration wizard on 2021-09-13 at 12:41 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 64001.
# Wizard options: compatible, lean_8colors, ascii, 2 lines, dotted, black-ornaments,
...
() {
  ...
  #######[ scalaenv: scala version from scalaenv (https://github.com/scalaenv/scalaenv) ]#######
  # Scala color.
  typeset -g POWERLEVEL9K_SCALAENV_FOREGROUND=168
  ...
  ##############[ toolbox: toolbox name (https://github.com/containers/toolbox) ]###############
  # Toolbox color.
  typeset -g POWERLEVEL9K_TOOLBOX_FOREGROUND=81
